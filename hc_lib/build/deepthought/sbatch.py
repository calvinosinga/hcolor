...
class Sbatch():
    ...
    def _default_sbatch_settings(self, jobname):
        ...
        sbatch_dir['account']='diemer-prj-astr'
    ...
    def _write_python_line(self, write_file, cmdargs=None):
        write_file.write("source /home/cosinga/my-venv/bin/activate\n")
        if cmdargs is None:
    ...
    def _compute_pk_memory(self):
        if self.resolution == 1600:
            return 80000
        else:
            return int(self._compute_grid_memory()*2.5)
