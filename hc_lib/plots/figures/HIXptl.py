...
def redshiftR_spaceC_fieldname(rlib, iprops, rmprops, savePath = '', panel_length = 3, panel_bt = 0.25,
    ...
    figArr, rowlabels, collabels = rlib.organizeFigure(iprops, row_prop, column_prop, 'pk', 0, rmprops)
    rlib.tohdf5(figArr, savePath, ['redshift','space','fieldname', 'snapshot', 'model'])
    return